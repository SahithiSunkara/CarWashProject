...
public class OrderServiceImpl implements OrderService{
	...
	public Images getImage(String imageName) {
		final Images retrievedImage = imgRepo.findByName(imageName);
		Images img = new Images(retrievedImage.getName(), retrievedImage.getType(),
				ImageCompress.decompressBytes(retrievedImage.getPicbyte()));
		return img;
	}
